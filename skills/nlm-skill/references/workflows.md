...
# Step 7: Generate podcast (or video with custom style)
nlm audio create research --format deep_dive --length default --confirm

# Alternative: Generate video with custom style
# nlm create video research --style custom --sd "structured style description with HEX codes" --focus "content focus" --language ja --confirm
